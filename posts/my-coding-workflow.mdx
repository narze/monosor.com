...
All my code stays in `~/Code/` of every machines I have.
Sometimes I have to switch the machine or I left my main Macbook at work. I use [`ghq`](https://github.com/x-motemen/ghq) to clone & navigate the repositories. You can configure this tool to use GitLab as well.
...
For commands I use, see [How I git](/how-i-git)
