...
- [Setapp](https://setapp.com/) - App bundles, saved money since I already use tons of apps.
  ...
  - [Sessions](https://setapp.com/apps/session) - Pomodoro
  - [Timing](https://setapp.com/apps/timing) - Time tracking
  - [Time Out](https://setapp.com/apps/time-out) - Hooks with Sessions to block screen on Pomodoro breaks
- [Syncthing](https://syncthing.net/)
- [Yabai](https://github.com/koekeishiya/yabai) - macOS tiling window manager

## Gadgets

- MacBook Pro M1 (16GB RAM) - New daily driver
...
- Full-size headphones with noise cancelling, I have [Sony MDR-1000X](https://www.sony.co.th/en/electronics/headband-headphones/mdr-1000x) & [Sonly WH-1000XM4](https://www.sony.co.th/en/electronics/headband-headphones/wh-1000xm4)
