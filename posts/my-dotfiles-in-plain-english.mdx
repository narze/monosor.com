---
title: My Dotfiles In Plain English
wip: true
---

# My Dotfiles In Plain English

I keep updating my [Dotfiles][1] to sync all of my Mac machines. Dotfiles are configuration files on the system which can be edit and share as a plain text. They're called "dotfiles" because they typically have leading `.` to make them hidden from the file system by default. Dotfiles can be built from scratch, or using tools like [rcm][2], [Dotbot][3], or even [Ansible][4]. Having shared Dotfiles availble on GitHub means I can setup a new Mac with all the apps I want using only a few commands. I use `make` command which calls Dotbot to install things for me, including :
...
[1]: https://github.com/narze/dotfiles
[2]: https://github.com/thoughtbot/rcm
[3]: https://github.com/anishathalye/dotbot
