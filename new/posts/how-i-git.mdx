...
Using Sourcetree is so 2010 😜
Some people said to me that they can choose only the files they want to stage and commit. Hold my beer!
...
I use this command alone so often I make the [one-letter alias](/command-line-alias) out of it.
...
- [`ghq`](/manage-all-the-git-repos-with-ghq)
